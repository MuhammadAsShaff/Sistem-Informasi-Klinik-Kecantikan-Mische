  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] pt-10 pb-20">
      <div className="max-w-[1300px] mx-auto px-4 md:px-6">
        ...
        {/* Hero Banner */}
        <div className="relative w-full bg-gradient-to-r from-[#56bc36] from-[55%] to-[#C6FFD1] rounded-tl-[30px] rounded-br-[30px]  overflow-hidden relative mb-12 flex items-center min-h-[160px] md:min-h-[200px] p-8 shadow-sm">
