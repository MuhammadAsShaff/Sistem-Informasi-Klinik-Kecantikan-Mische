...
/**
 * Bagian info klinik (deskripsi, visi, misi, jam operasional, jumlah dokter).
 * Pure UI — semua data dari hook `useTentangKami`.
 */
        ...
        <div className="flex flex-row gap-4 md:gap-24 mt-4 md:mt-8 justify-between md:justify-start">
          <div className="flex flex-col gap-2 md:gap-3 w-1/2 md:w-auto">
            ...
            <div className="flex items-center gap-2 md:gap-4">
              ...
              <span className="text-[12px] sm:text-2xl md:text-4xl font-extrabold text-black tracking-tight">
                {jamOperasional}
              </span>
            </div>
          </div>
