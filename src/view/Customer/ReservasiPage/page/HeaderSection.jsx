...
export default function HeaderSection() {
  return (
    <div className="relative w-full bg-gradient-to-r from-[#56bc36] from-[30%] to-[#C6FFD1] rounded-[2rem] md:rounded-[3rem] p-8 md:p-14 lg:p-20 overflow-hidden shadow-2xl shadow-green-900/20 animate-in fade-in slide-in-from-top duration-700">
      <div className="relative z-10 max-w-3xl">
        <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-5xl font-bold text-white leading-tight md:leading-[1.1] drop-shadow-md text-left">
