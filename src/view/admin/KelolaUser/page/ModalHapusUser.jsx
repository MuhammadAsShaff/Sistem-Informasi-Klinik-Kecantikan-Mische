...
/**
 * PLANG PERINGATAN PENCABUTAN KEANGGOTAAN (ModalHapusUser)
 * Ibarat plang peringatan bersimbol seru (!) besar yang dipasang mandor di depan buku besar keanggotaan.
 * Plang ini menanyakan ketegasan pimpinan: "Benarkah Anda ingin mencoret dan mencabut keanggotaan ini?".
 * Jika menekan "Ya, Hapus", Petugas Pencoret (useHapusUser) langsung mencoret namanya secara permanen.
 */
