...
/**
 * TANDA PERINGATAN PEMUSNAH BUKU RIWAYAT (ModalHapusPengaturan)
 * Ibarat plang segel bersimbol seru (!) besar yang menghalangi meja buku riwayat klinik.
 * Plang ini mengingatkan konsekuensi besar: "Yakin ingin membakar bersih semua isi riwayat, visi, dan misi?".
...
const ModalHapusPengaturan = ({ isOpen, onClose, onConfirm }) => {
  if (!isOpen) return null; // Jika saklar ditutup, plang segel disembunyikan

  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white w-full max-w-md rounded-2xl p-8 text-center shadow-xl">
        
        {/* Simbol seru tanda peringatan penting */}
