    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 font-poppins">
      <div className="bg-white rounded-lg w-full max-w-4xl mx-4 overflow-hidden animate-in zoom-in-95 duration-200">
        <div className="flex justify-between items-center p-6 border-b border-gray-200">
          <h2 className="text-xl font-bold text-black">Tambah Kategori Produk</h2>
        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div>
              ...
              <div className="relative">
                <select className="w-full border border-gray-300 rounded p-3 text-sm outline-none focus:border-gray-400 appearance-none bg-white">
                  <option value="" disabled selected>Pilih Jenis Testimoni</option>
