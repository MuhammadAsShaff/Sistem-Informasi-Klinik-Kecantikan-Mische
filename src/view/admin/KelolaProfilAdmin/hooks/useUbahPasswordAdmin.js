...
/**
 * Hook untuk mengelola form ubah password admin (UPDATE password).
 * Termasuk: state form, validasi, toggle show/hide, reset, dan submit.
 *
 * @param {Object}   formData   - Data profil saat ini (dikirim bersama payload password)
