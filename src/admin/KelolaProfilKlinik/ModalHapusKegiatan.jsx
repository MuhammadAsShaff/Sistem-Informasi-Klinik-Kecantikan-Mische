...
const ModalHapusKegiatan = ({ isOpen, onClose }) => {
      ...
      <div className="bg-white w-full max-w-[400px] rounded-[24px] p-8 shadow-2xl animate-in fade-in zoom-in duration-300">
        ...
        <div className="flex flex-col text-center items-center">
          ...
          <div className="flex items-center gap-3 w-full">
            <button
              className="flex-1 bg-[#55BC36] text-white py-3 rounded-xl font-bold text-sm hover:bg-[#46a02b] transition-all shadow-md shadow-red-100"
            >
              Ya, Hapus
            </button>
            <button
